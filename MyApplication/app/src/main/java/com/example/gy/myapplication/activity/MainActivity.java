...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String HTTP_ROOT = "http://192.168.137.1:8080/";
    ...
    class MusicReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(musicIndex != index){
                ...
                textViewTotal.setText(String.valueOf(format(total)));
            ...
            textViewCurr.setText(String.valueOf(format(curr)));
        }
    }
    ...
    public static String formatLong(String format,long num) {
